...
<svelte:head>
	<title>{data.ticket.subject} - Admin Support Ticket | TitanNode</title>
</svelte:head>

<div class="max-w-screen-xl">
	<!-- Header -->
	<div class="mb-8">
		<a href="/admin/tickets" class="mb-4 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
			...
			<div class="flex gap-2">
				...
				{#if data.ticket.user.supportPin}
					<Button
						variant="outline"
						class="gap-2"
						onclick={() => goto(`/admin/users?search=${data.ticket.user.supportPin}`)}
					>
		...
		<div class="space-y-6">
			...
			<Card class="border-border/50">
				...
				<CardContent class="space-y-2">
					<a href="/admin/tickets" class="block">
