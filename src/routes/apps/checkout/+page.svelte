...
<svelte:head>
	<title>Checkout - App Hosting bestellen | TitanNode</title>
</svelte:head>
			...
			<Card class="border-border/50">
				...
				<CardContent class="space-y-3">
					...
					<div class="flex justify-between text-sm">
						...
						<span class="font-medium">{data.app}</span>
					</div>
					<div class="flex justify-between text-sm">
			...
			<Card class="border-border/50 sticky top-4">
				...
				<CardContent class="space-y-4">
					...
					<div class="pt-4 text-xs text-muted-foreground">
						<p>Nach erfolgreicher Zahlung wird deine App automatisch erstellt und ist in wenigen Minuten verfügbar.</p>
					</div>
				</CardContent>
			</Card>
		</div>
