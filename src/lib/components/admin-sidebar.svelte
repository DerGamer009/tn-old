<script lang="ts">
	...
	const navItems = [
		{ href: '/admin', icon: 'tabler:dashboard', label: 'Dashboard' },
		{ href: '/admin/tickets', icon: 'tabler:ticket', label: 'Tickets' },
		{ href: '/admin/bewerbungen', icon: 'tabler:briefcase', label: 'Bewerbungen' },
		{ href: '/admin/users', icon: 'tabler:users', label: 'Benutzer' },
		{ href: '/admin/team', icon: 'tabler:users-group', label: 'Team' },
		{ href: '/admin/invoices', icon: 'tabler:receipt', label: 'Rechnungen' },
		{ href: '/admin/servers', icon: 'tabler:server', label: 'Server' },
		{ href: '/admin/nodes', icon: 'tabler:server-2', label: 'Nodes' },
		{ href: '/admin/announcements', icon: 'tabler:speakerphone', label: 'Ankündigungen' },
		{ href: '/admin/settings', icon: 'tabler:settings', label: 'Einstellungen' }
	];
			...
			<div class="flex h-full flex-col">
				...
				<div class="flex h-16 items-center gap-2 border-b px-6">
					...
					<div class="flex flex-col">
						...
						<span class="text-[11px] text-muted-foreground">Admin Panel</span>
					</div>
				</div>
					...
					<div class="flex items-center gap-3">
						...
						<div class="flex-1 min-w-0">
							...
							{#if user.role}
								...
								<Badge variant="outline" class="{ROLE_COLORS[role]} text-[11px]">
									{ROLE_NAMES[role]}
								</Badge>
							{/if}
